...
public class UsuarioController {
    ...
    public UsuarioController(UsuarioDAO usuarioDao,CrearUsuario crearUsuario,BorrarUsuario eliminarUsuario,BuscarUsuario buscarUsuario,ActualizarUsuario actualizarUsuario,ListarUsuario listaUsuarios) {
    ...
    public void agregarUsuario() {
        ...
        int respuesta = JOptionPane.showConfirmDialog(crearUsuario,agUmsj,cfmLmsj,JOptionPane.YES_NO_OPTION);
        if (respuesta == JOptionPane.YES_OPTION) {
            ...
            try {
                ...
                if (cedula.isEmpty() || nombre.isEmpty() || apellido.isEmpty() || telefono.isEmpty() || correo.isEmpty() || direccion.isEmpty() || fechaTexto.isEmpty()) {
    ...
    public void buscarUsuario() {
        try {
            String cedula = buscarUsuario.getjTextFieldBUCedula().getText().trim();

            if (cedula.isEmpty()) {
                throw new IllegalArgumentException(IDUmsj);
            }
            ...
            buscarUsuario.getjTextFieldBUDireccion().setText(usuario.getDireccion());
    ...
    public void buscarActualizarUsuario() {
        try {
            String cedula = actualizarUsuario.getjTextFieldAUCedula().getText().trim();
    ...
    public void actualizarUsuario() {
        try {
            ...
            int respuesta = JOptionPane.showConfirmDialog(actualizarUsuario,actUmsj,cfmLmsj,JOptionPane.YES_NO_OPTION);

            if (respuesta == JOptionPane.YES_OPTION) {
                
                String nombre = actualizarUsuario.getjTextFieldAUNombre().getText().trim();

                String apellido = actualizarUsuario.getjTextFieldAUApellido().getText().trim();

                String telefono = actualizarUsuario.getjTextFieldAUTelefono().getText().trim();

                String correo = actualizarUsuario.getjTextFieldAUCElectronico().getText().trim();

                String direccion = actualizarUsuario.getjTextFieldAUDireccion().getText().trim();

                String fechaTexto = actualizarUsuario.getjTextFieldAUFNacimiento().getText().trim();

                if (nombre.isEmpty() || apellido.isEmpty() || telefono.isEmpty() || correo.isEmpty() || direccion.isEmpty() || fechaTexto.isEmpty()) {
    ...
    public void buscarEliminarUsuario() {
        try {
            String cedula = eliminarUsuario.getjTextFieldEUCedula().getText().trim();
            ...
            eliminarUsuario.getjTextFieldEUDireccion().setText(String.valueOf(usuario.getDireccion()));
    ...
    public void eliminarUsuario() {
        try {
            ...
            usuarioDao.buscar(cedula);
            int respuesta = JOptionPane.showConfirmDialog(eliminarUsuario,dlUmsj,cfmLmsj,JOptionPane.YES_NO_OPTION);
